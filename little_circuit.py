...
i2 = State(d1 , name="input2")
i3 = State(d2 , name="input3")
...
model.add_states(i1,i2,i3,i4,i5,i6,i7,gn1,ga2,ga3,go4,ga5,go6,ga7)
model.add_edge(i1, gn1)
