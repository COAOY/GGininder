...
time ./atpg -tdfatpg -ndet 1 ../sample_circuits/bseries/b$1_C.bench.txt.ckt > ../log1
# ../bin/golden_tdfsim -ndet 1 -tdfsim ../log1 ../sample_circuits/bseries/b$1_C.bench.txt.ckt > ../log1
python util.py ../log1

echo "[CPDAG selection]"
time ./atpg -tdfatpg -cpdag -ndet 1 ../sample_circuits/bseries/b$1_C.bench.txt.ckt > ../log2
